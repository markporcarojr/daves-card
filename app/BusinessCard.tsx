  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-900">
      ...
      >
        ...
        <div
          className="absolute w-80 h-48 bg-white shadow-2xl rounded-xl overflow-hidden"
        ...
        <div
          className="absolute w-80 h-48 bg-gray-800 shadow-2xl rounded-xl overflow-hidden flex items-center justify-center"
